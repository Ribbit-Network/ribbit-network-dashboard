...
def serve_layout() -> html.Div:
    return html.Div([
        ...
        html.Div([
            ...
            html.A(html.H3('Support'), href='https://givebutter.com/ribbitnetwork',
                   style={'marginLeft': '2em', 'textDecoration': 'underline', 'color': 'black'}),
            html.A(html.H3('FAQ'), href='https://ribbitnetwork.notion.site/FAQ-Frog-sensor-edf42fd302a34430abedff4e1df3da45',
                   style={'marginLeft': '2em', 'textDecoration': 'underline', 'color': 'black'}),
        ], id='nav'),
